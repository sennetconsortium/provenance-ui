...
| **includeStyles**                   | *boolean*              | Import the css styles or not: `true`, `false`. Default: `false`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| **onNodeCssClass**   | The callback to run when building the node class                                   | *string*             | The class to append to a node g tag           | 
