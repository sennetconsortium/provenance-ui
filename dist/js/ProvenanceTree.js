...
function ProvenanceTree(d3, selector, _options) {
  ...
  function handleZoomActivation() {
    ...
    (0, _jquery.default)(selector).click(e => {
      enableZoom();
    });
    (0, _jquery.default)(document).on('scroll', e => {
      if (!isElementInViewport((0, _jquery.default)(selector)[0])) {
        disableZoom();
      }
    });
  }
  ...
  function stratify(data, parentKey) {
    parentKey = parentKey || _DataConverter.default.KEY_P_ACT;
    let has = {};
    let x = 0;
